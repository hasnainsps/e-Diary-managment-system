   <div id="layoutSidenav_nav" >
                <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                    <div class="sb-sidenav-menu" style="background-color: #470e0e;">
                        <div class="nav">
                            <div class="sb-sidenav-menu-heading">Core</div>
                            <a class="nav-link side-font-color" href="dashboard.php">
...
{ $fullname=$row['firstName']." ".$row['lastName'];
    ...
    ?>
                    ...
                    <div class="sb-sidenav-footer" style="background-color: #470e0e; color: #44fcf9;">
